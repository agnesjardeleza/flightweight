...
while i < 10
	post = Post.create(poster_id: 2, weight: i+1, date_of_flight: '2015-04-30 08:00:00', details: 'detail' + i.to_s, flight_number: 12+i , category: 'request', origin: 'manila', destination: 'cebu', is_active: true)
	post = Post.create(poster_id: 3, weight: i+1, date_of_flight: '2015-04-30 12:00:00', details: 'detail' + i.to_s, flight_number: 123+i+1, category: 'advertisement', origin: 'cebu', destination: 'manila', is_active: true)
	i = i+1
end